...
const organizations = [
  {
    id: 1,
    name: 'Stripe Inc.',
    subdomain: 'stripe-prod-env',
    createdDate: 'Oct 12, 2023',
    plan: 'Enterprise',
    notificationsMTD: '1,240,582',
    status: 'Active',
    color: 'bg-purple-500',
  },
  {
    id: 2,
    name: 'Airbnb, Inc.',
    subdomain: 'airbnb-main',
    createdDate: 'Nov 02, 2023',
    plan: 'Pro',
    notificationsMTD: '458,102',
    status: 'Active',
    color: 'bg-pink-500',
  },
  {
  ...
  },
  {
    id: 4,
    name: 'Tesla Labs',
    subdomain: 'tesla-fleet-ops',
    createdDate: 'Jan 10, 2024',
    plan: 'Enterprise',
    notificationsMTD: '2,890,211',
    status: 'Active',
    color: 'bg-red-500',
  },
  {
    id: 5,
    name: 'Reddit',
    subdomain: 'reddit-ads-eng',
    createdDate: 'Jan 22, 2024',
    plan: 'Pro',
    notificationsMTD: '712,443',
    status: 'Active',
    color: 'bg-orange-500',
  },
]
      ...
      <div className="p-8">
        ...
        <Card className="border border-border overflow-hidden">
          ...
          <div className="flex items-center justify-between p-4 border-t border-border bg-muted/50">
            <p className="text-sm text-muted-foreground">Showing 1-5 of {organizations.length} results</p>
